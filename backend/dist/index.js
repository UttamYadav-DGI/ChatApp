    ...
    socket.on("message", (message) => {
        try {
            ...
            if (ParsedMessage.type === "join") {
                ...
                console.log(`👤 User ${ParsedMessage.payload.clientId} joined room: ${ParsedMessage.payload.roomId}`);
            ...
            if (ParsedMessage.type === "chat") {
                ...
                console.log(`📤 Message relayed to ${sentCount} users in room: ${currentUserRoom}`);
            }
        }
        catch (error) {
